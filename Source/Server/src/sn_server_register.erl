...
-export([register_account/2, register_account/4, make_json/0]). 
...
register_account( UserName, Password ) ->
	log4erl:info( "~n~p~p~n", [UserName, Password] ), 
	%%% TODO Call sn_db_inf里面的逻辑. Do the register job
	ok.
